...
public class MutuusApplication {
    ...
    public CommandLineRunner commandLineRunner(
        ...
        return args -> {
            ...
            origin.setLatitude(Double.valueOf("37.7749"));
            origin.setLongitude(Double.valueOf("-122.4194"));
            ...
            destiny.setLatitude(Double.valueOf("51.5074"));
            destiny.setLongitude(Double.valueOf("-0.1278"));
